...
@ConditionalOnEnabledMetricsExport("dynatrace2")
...
public class DynatraceMetricsExportAutoConfiguration {
	...
	public DynatraceConfig dynatraceConfigV2() {
		return new DynatracePropertiesConfigAdapter(this.properties);
	}

	@Bean
	@ConditionalOnMissingBean
	public DynatraceMeterRegistry dynatraceMeterRegistryV2(DynatraceConfig dynatraceConfigV2, Clock clock) {
		return DynatraceMeterRegistry.builder(dynatraceConfigV2).clock(clock).httpClient(
